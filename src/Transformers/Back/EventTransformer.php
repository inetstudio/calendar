...
namespace InetStudio\Calendar\Transformers\Back;

use League\Fractal\TransformerAbstract;
use League\Fractal\Resource\Collection as FractalCollection;
use InetStudio\Calendar\Contracts\Transformers\Back\EventTransformerContract;
...
class EventTransformer extends TransformerAbstract implements EventTransformerContract
{
    ...
    public function transform($item): array
    {
        ...
        return [
            ...
            'tooltip' => view('admin.module.'.$this->module.'::back.partials.calendar.tooltip', [
                'item' => $item,
            ])->render(),
        ];
    }
